...
public class Transition implements ITransition {
    ...
    public  ITimedExprGenerator2IGuardExpr2JavaGenerator time;
    ...
    public Transition(BaseStateDelegator start, BaseStateDelegator end, ITimedExprGenerator2IGuardExpr2JavaGenerator time, BaseActionDelegator action) {
        this.start = start;
        this.end = end;
        this.time = time;
        this.action = action;
